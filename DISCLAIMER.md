...
kind**. This statement summarizes and supplements the warranty disclaimer and
liability limitation already set out in sections 15–17 of the
[GNU Affero General Public License v3](LICENSE) under which the software is
...
- **Availability**, **uptime**, or **reliability** of the software or any
  service built on it;
- **Non-infringement**;
- **Security** or freedom from defects, errors, or vulnerabilities.

You bear the **entire risk** as to the quality, correctness, and performance of
the software. You are solely responsible for validating that any output is
correct and suitable before relying on it, and for maintaining appropriate
backups and review processes.
...
The disclaimers above reflect the terms of open-source software offered free of
