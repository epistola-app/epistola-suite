...
| Job                     | Waits for           | Runs                                                                                                                                                                                                            |
| ----------------------- | ------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `compile`               | nothing             | `pnpm build`, then one Gradle call: `checkMigrationVersions checkChangelogFragments checkBundledCatalogVersions ktlintCheck checkContractVersionAlignment testClasses`; ships the build cache to the other jobs |
