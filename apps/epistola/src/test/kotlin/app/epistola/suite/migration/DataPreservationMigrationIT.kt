...
class DataPreservationMigrationIT {
    ...
    private fun verify(connection: Connection) {
        connection.createStatement().use { statement ->
            ...
            // Relocation re-keyed attributes onto their identity (V20260828132828) and dropped the
            // generation-history foreign keys into the template hierarchy (V20260831161109).
