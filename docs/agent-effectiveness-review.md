...
| ---- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------- | ------ | ------------------------------------------------------- |
| P0.1 | Quarantine `command-query`, `contract-change`, `editor-component`, `htmx-form`, `ui-test` and `unit-test` (`disable-model-invocation: true` plus an "outdated" banner). Delete the duplicate `pr-review/mcp.md`.                                                                                                  | R1                              | S      | Codex cannot see them today                             |
