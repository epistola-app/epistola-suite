...
- This resource's shape has been stable since it was first documented. It carries the catalog-wide `schemaVersion` (currently `4`), not an independent asset version.
