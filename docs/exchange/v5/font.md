...
- No shape change is known for this resource (no prior committed fixture). On the wire it carries the catalog-wide `schemaVersion` (currently `5`), not an independent font version.
