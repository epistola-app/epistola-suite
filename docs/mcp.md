...
| Tool                      | Purpose                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| ------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `list_catalogs`           | Discover catalogs in the current tenant, including qualified attributes, exact-case keywords, presentation asset slugs, and license metadata.                                                                                                                                                                                                                                                                                                                                                                                |
| `preview_catalog_upgrade` | Preview what upgrading a SUBSCRIBED catalog to its source's latest release would do (source-vs-source): `added`/`removed`/`changed`/`unchanged` (each `type/slug`), changed metadata sections, and cross-catalog `conflicts`. Read-only — the upgrade action is UI-only.                                                                                                                                                                                                                                                     |
...
| `get_version`             | Fetch one exact template version, including its persisted node/slot graph and the rendering-default and resolved-theme snapshots frozen at publication. Use this for historical and generated-output diagnostics.                                                                                                                                                                                                                                                                                                            |
...
| `analyze_template_data`   | Check data against the contract of the version `preview_document` would render, without rendering. Returns the missing fields (required ones always, optional ones only when the template reads them) and the invalid fields, each with a JSON Pointer into `data` and the field's JSON Schema, so an agent can ask for exactly the data the template still needs. See [Missing and invalid data](data-contracts.md#missing-and-invalid-data).                                                                               |
