...
| [0014](0014-safe-catalog-resource-relocation.md) Safe resource relocation                             | Accepted, amended              | Relocation semantics; the alias half was withdrawn before release — a crude move remains.                                                                                   |
