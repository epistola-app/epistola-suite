...
| [0014](0014-safe-catalog-resource-relocation.md) Safe resource relocation                             | Accepted, superseded in part   | Relocation semantics; its alias half is withdrawn by ADR 0025.                                                                                                              |
...
| [0020](0020-where-a-catalog-resource-address-lives.md) Where a resource address lives                 | Accepted, amended              | Keeps the address on the resource row; the registry allocates identity (amended by 0025).                                                                                   |
...
| [0022](0022-installation-bindings.md) Installation bindings                                           | Draft                          | Discussion record on source identity, dependency sources and what a publisher leaves open; roles, then overridable resources, both dropped — see its addenda; not accepted. |
