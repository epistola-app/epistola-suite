...
| [0019](0019-demo-api-shared-secret.md) Demo API shared secret                        | Accepted — implemented         | One all-tenant credential for the demo website, gated on the `demo` profile. |
