...
test.describe('Block Operations - Adding Blocks', () => {
  ...
  test('add multiple blocks preserves order', async ({ page, appHelpers }) => {
    ...
    const types = [BLOCK_TYPES.text, BLOCK_TYPES.container, BLOCK_TYPES.conditional];
  ...
  test('add child block to container', async ({ page, appHelpers }) => {
    ...
    await expect(container.locator('.empty-state')).toContainText('Drop blocks here');
  ...
  test('add child block to conditional', async ({ page, appHelpers }) => {
    ...
    await expect(conditional.locator(`[data-block-type="${BLOCK_TYPES.text}"]`)).toBeVisible();
  });
  ...
  test('add child block to loop', async ({ page, appHelpers }) => {
    ...
    await expect(loop.locator(`[data-block-type="${BLOCK_TYPES.text}"]`)).toBeVisible();
  });
});

test.describe('Block Operations - Deleting Blocks', () => {
  test('delete single block via delete button', async ({ page, appHelpers }) => {
    await appHelpers.addTextBlock();
    const initialCount = await appHelpers.getBlockCount();
  ...
  test('delete container with children removes everything', async ({ page, appHelpers }) => {
    await appHelpers.addContainerBlock();
    const container = appHelpers.getBlockByType(BLOCK_TYPES.container).last();
  ...
  test('delete one block among multiple leaves others intact', async ({ page, appHelpers }) => {
    await appHelpers.addTextBlock();
    await appHelpers.addTextBlock();
    await appHelpers.addTextBlock();
...
test.describe('Block Operations - Selecting Blocks', () => {
  ...
  test('selecting another block deselects previous', async ({ page, appHelpers }) => {
    await appHelpers.addTextBlock();
    await appHelpers.addTextBlock();
...
test.describe('Block Operations - Moving Blocks', () => {
  test.skip('drag block from root into container', async ({ page, appHelpers }) => {
...
test.describe('Block Operations - Columns', () => {
  test('add column button increases column count', async ({ page, appHelpers }) => {
    await appHelpers.addColumnsBlock();
    ...
    expect(await block.locator('.column-wrapper').count()).toBe(initialCount + 1);
  });

  test('remove column button decreases column count', async ({ page, appHelpers }) => {
    await appHelpers.addColumnsBlock();
    const block = appHelpers.getBlockByType(BLOCK_TYPES.columns).last();
...
test.describe('Block Operations - Table', () => {
  ...
  test('remove row button decreases row count', async ({ page, appHelpers }) => {
    await appHelpers.addTableBlock();
    const block = appHelpers.getBlockByType(BLOCK_TYPES.table).last();
  ...
  test('clicking add text in table cell creates a text block', async ({ page, appHelpers }) => {
    await appHelpers.addTableBlock();
    const block = appHelpers.getBlockByType(BLOCK_TYPES.table).last();
