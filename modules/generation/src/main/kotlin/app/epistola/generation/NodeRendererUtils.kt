 ...
 */
fun extractExpression(prop: Any?, defaultLanguage: ExpressionLanguage): Expression? {
 ...
 *
 * The v2 [Node.styles] is typed as `Map<String, Any?>?` but style applicators expect
 ...
 */
fun parseBorderStyle(borderStyleStr: String?): BorderStyle = borderStyleStr?.let {
    try {
