...
export const stylingTour: Tour = {
  ...
  steps: () => [
    {
      target: '[data-editor-anchor~="page-settings"]',
    ...
    {
      target: '[data-editor-anchor~="document-styles"]',
    ...
    },
    {
      ...
      target: '[data-editor-anchor~="canvas-block"]',
    ...
    },
    {
      ...
      target: '[data-editor-anchor~="style-preset"]',
