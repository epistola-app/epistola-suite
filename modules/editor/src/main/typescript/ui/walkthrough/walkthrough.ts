...
import popoverOverrides from './walkthrough.css?inline';
...
// driver's own CSS + our re-skin (see walkthrough.css), one injected <style>.

function ensureDriverStyles(): void {
  injectStyleOnce(STYLE_ID, driverCss + popoverOverrides);
}
