...
class FeedbackSyncScheduler(
    ...
    // Per-item outcome of the outbound feedback sync. Lets a fleet alert on a
    // rising failure rate (provider down / misconfigured) and confirm the
    // scheduler is doing work at all.
