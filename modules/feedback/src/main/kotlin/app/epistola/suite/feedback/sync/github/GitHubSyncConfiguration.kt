 ...
 * [app.epistola.suite.feedback.sync.NoOpIssueSyncAdapter] is used instead
...
class GitHubSyncConfiguration {
    ...
    @Bean
    fun gitHubIssueSyncAdapter(
        authService: GitHubAppAuthService,
        gitHubRestClient: RestClient,
        objectMapper: ObjectMapper,
    ): IssueSyncPort = GitHubIssueSyncAdapter(authService, gitHubRestClient, objectMapper)
}
