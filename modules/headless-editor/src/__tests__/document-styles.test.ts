...
describe('Document Styles', () => {
  describe('updateDocumentStyles', () => {
    ...
    it('should partial update preserve other styles', () => {
      const editor = new TemplateEditor();
    ...
    it('should undo revert document styles changes', () => {
      const editor = new TemplateEditor();
      ...
      expect(editor.getTemplate().documentStyles?.fontFamily).toBe('Times New Roman');
