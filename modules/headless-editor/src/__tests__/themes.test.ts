...
describe('TemplateEditor themes', () => {
  ...
  describe('setDefaultTheme', () => {
    it('should set default theme', () => {
      const editor = new TemplateEditor();
      const theme: ThemeSummary = { id: 'default', name: 'Default Theme', description: 'The default' };
  ...
  describe('updateThemeId', () => {
    ...
    it('should trigger template change callback', () => {
      ...
      const lastCall = onTemplateChange.mock.calls[onTemplateChange.mock.calls.length - 1];
