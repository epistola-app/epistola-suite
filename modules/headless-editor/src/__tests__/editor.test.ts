...
describe('TemplateEditor', () => {
  ...
  describe('addBlock', () => {
    ...
    it('should add block to a column', () => {
      const editor = new TemplateEditor();
      const columns = editor.addBlock('columns')! as { columns: { id: string }[] };
    ...
    it('should add block to a table cell', () => {
      const editor = new TemplateEditor();
      const table = editor.addBlock('table')! as { rows: { cells: { id: string }[] }[] };
  ...
  describe('updateBlock', () => {
    ...
    it('should update styles on a block', () => {
      ...
      const updated = editor.findBlock(block.id) as { styles: Record<string, unknown> };
  ...
  describe('columns operations', () => {
    ...
    it('should remove a column', () => {
      ...
      const updated = editor.findBlock(columns.id) as { columns: { id: string }[] };
  ...
  describe('table operations', () => {
    ...
    it('should add header row to table', () => {
      ...
      const updated = editor.findBlock(table.id) as { rows: { isHeader?: boolean }[] };
  ...
  describe('block registry', () => {
    ...
    it('should register a custom block type', () => {
      ...
      editor.registerBlock({
        type: 'custom-banner',
        create: (id) => ({ id, type: 'custom-banner' as const, content: 'Banner' } as Block),
