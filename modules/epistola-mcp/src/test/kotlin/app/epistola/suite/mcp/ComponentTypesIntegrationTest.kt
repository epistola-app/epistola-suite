...
/**
 * Verifies that the contract component registry is exposed through the MCP
 * `list_component_types` / `get_component_type` tools.
 */
class ComponentTypesIntegrationTest : IntegrationTestBase() {
    ...
    fun `list_component_types exposes the editor's component types`() {
        ...
        // The current registry has 20 components. Asserting on the count
