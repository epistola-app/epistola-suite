...
class ComponentMcpTools(
    ...
    @McpTool(
        ...
        description = "List all component types the editor supports — the building blocks of a template's " +
            ...
            "inspector fields, and default props/styles. Use this to design templates from scratch or " +
            "to validate that a node type referenced in template content is supported. " +
