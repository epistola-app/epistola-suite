...
class DraftVersionFactory(
    ...
    fun ensureDraft(
        ...
        if (existingDraft != null) {
            templateDocumentPreparation.prepareDraft(existingDraft.templateModel, variantId.catalogKey)
        ...
        val prepared = templateDocumentPreparation.prepareDraft(modelToSave, variantId.catalogKey)
